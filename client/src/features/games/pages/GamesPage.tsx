          ...
          >
            ...
            <div className="p-10 flex-1 flex flex-col justify-between space-y-8">
               <div className="space-y-4">
                  <h3 className="text-3xl font-black text-warm-text group-hover:text-primary transition-colors leading-tight">{game.title}</h3>
               ...
               <div className="flex items-center justify-between pt-6 border-t border-stone-100">
                  {game.playLink ? (
                    <a 
                      href={game.playLink} 
                      target="_blank" 
                      className="bg-primary text-warm-bg px-8 py-3 rounded-full font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-warm-text transition-all shadow-lg shadow-primary/10"
                    >
                  ...
                  <button className="w-12 h-12 rounded-full border border-stone-200 flex items-center justify-center text-stone-400 hover:text-primary hover:border-primary transition-all">
