...
export default function BlogListPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 space-y-24">
      ...
      <div className="grid grid-cols-1 gap-12 pb-40 max-w-5xl">
        {blogs.map((blog, i) => (
          <motion.div 
            key={blog.id}
          ...
          >
            ...
            <div className="flex-1 space-y-6 py-4">
               ...
               <button className="flex items-center gap-3 text-warm-text font-black text-[10px] uppercase tracking-[0.2em] group-hover:text-primary transition-all pt-2">
