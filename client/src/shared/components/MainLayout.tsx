...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen bg-warm-bg text-warm-text font-sans selection:bg-primary/10">
      ...
      <footer
        className="py-24 relative z-10 text-center overflow-hidden"
        style={{
          backgroundColor: '#3d0f0c', // Background fallback
          backgroundImage: 'url("/footer.jpg")',
          backgroundRepeat: 'repeat',
          backgroundSize: '300px', // Controls the "tile size" of the loop
          borderTop: '1px solid #571813'
        }}
      >
        {/* Subtle overlay to reduce contrast and keep text readable */}
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-20">
          ...
          <div className="flex justify-center gap-12 mb-16">
            <div className="text-[#FAF7F2] hover:text-white font-black text-[10px] tracking-widest cursor-pointer transition-all">INSTAGRAM</div>
            <div className="text-[#FAF7F2] hover:text-white font-black text-[10px] tracking-widest cursor-pointer transition-all">TWITTER</div>
            <div className="text-[#FAF7F2] hover:text-white font-black text-[10px] tracking-widest cursor-pointer transition-all">YOUTUBE</div>
          </div>
          <p className="text-[10px] text-[#FAF7F2] uppercase tracking-[0.4em] font-black">
            © 2026 {t('studio_name')}
          </p>
        </div>
      </footer>
